...
#define HOMING_BUMP_MM      { 0, 0, 2 }  //rado without sensorless homing { 4, 4, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 0 }  //{ 4, 4, 0 } (mm) Backoff from endstops after homing
