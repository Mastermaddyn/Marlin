...
//#define SHOW_BOOTSCREEN //rado

// Show the bitmap in Marlin/_Bootscreen.h on startup.
//#define SHOW_CUSTOM_BOOTSCREEN //rado

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
//#define CUSTOM_STATUS_SCREEN_IMAGE //rado
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  019.5
    #define DEFAULT_Ki   001.88
    #define DEFAULT_Kd  050.4
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 017.1
  #define DEFAULT_bedKi 001.10
  #define DEFAULT_bedKd 178.7
...
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 7)
...
#define HOMING_FEEDRATE_MM_M { (25*60), (25*60), (20*60) }
